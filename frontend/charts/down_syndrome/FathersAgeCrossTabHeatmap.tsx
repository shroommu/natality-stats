...
const DATA_FILE = "down_syndrome/fathers_age_cross_tab.json";

export default function FathersAgeCrossTabHeatmap() {
  ...
  return (
    <ChartDataBoundary loading={loading} error={error}>
      {data && rowKeysInOrder.length > 0 && (
        <ResponsiveHeatmap
          title="Father's Age and Down Syndrome Presence"
          columnMajor={data}
