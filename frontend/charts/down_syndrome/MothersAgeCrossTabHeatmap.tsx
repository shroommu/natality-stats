...
const DATA_FILE = "down_syndrome/mothers_age_cross_tab.json";

export default function MothersAgeCrossTabHeatmap() {
  ...
  return (
    <ChartDataBoundary loading={loading} error={error}>
      {data && rowKeysInOrder.length > 0 && (
        <ResponsiveHeatmap
          title="Mother's Age and Down Syndrome Presence"
          columnMajor={data}
