...
const DATA_FILE = "down_syndrome/mothers_race_cross_tab.json";

export default function MothersRaceCrossTabHeatmap() {
  ...
  return (
    <ChartDataBoundary loading={loading} error={error}>
      {data && rowKeysInOrder.length > 0 && (
        <ResponsiveHeatmap
          title="Mother's Race and Down Syndrome Presence"
          columnMajor={data}
