...
const DATA_FILE = "vbac/birth_weight_in_grams_value_counts.json";
const TITLE = "Distribution of birth weight in grams";

export default function BirthWeightInGramsValueCountsBarChart() {
