...
const DATA_FILE = "vbac/fathers_combined_age_cross_tab.json";

export default function FathersCombinedAgeCrossTabHeatmap() {
  ...
  return (
    <ChartDataBoundary loading={loading} error={error}>
      {data && rowKeysInOrder.length > 0 && (
        <ResponsiveHeatmap
          title="Father's Combined Age and Successful VBAC"
          columnMajor={data}
          ...
          yAxisLabel="Father's Combined Age"
