...
const DATA_FILE = "vbac/augmentation_of_labor_value_counts.json";
const TITLE = "Labor augmentation counts";

export default function AugmentationOfLaborValueCountsBarChart() {
