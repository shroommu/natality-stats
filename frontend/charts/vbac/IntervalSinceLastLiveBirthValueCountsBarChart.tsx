...
const DATA_FILE = "vbac/interval_since_last_live_birth_value_counts.json";
const TITLE = "Distribution of interval since last live birth";

export default function IntervalSinceLastLiveBirthValueCountsBarChart() {
