...
const DATA_FILE = "vbac/weight_gain_cross_tab.json";

export default function WeightGainCrossTabHeatmap() {
    ...
    <ChartDataBoundary loading={loading} error={error}>
      {data && rowKeysInOrder.length > 0 && (
        <ResponsiveHeatmap
          ...
          yAxisLabel="Weight Gain During Pregnancy (lbs)"
