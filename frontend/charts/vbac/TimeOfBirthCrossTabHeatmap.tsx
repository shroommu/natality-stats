...
const DATA_FILE = "vbac/time_of_birth_cross_tab.json";

export default function TimeOfBirthCrossTabHeatmap() {
  ...
  return (
    <ChartDataBoundary loading={loading} error={error}>
      {data && rowKeysInOrder.length > 0 && (
        <ResponsiveHeatmap
          title="Time of Birth and Successful VBAC"
          columnMajor={data}
