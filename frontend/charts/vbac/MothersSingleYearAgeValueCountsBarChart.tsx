...
const DATA_FILE = "vbac/mothers_single_year_age_value_counts.json";
const TITLE = "Distribution of mother's single year age";

export default function MothersSingleYearAgeValueCountsBarChart() {
