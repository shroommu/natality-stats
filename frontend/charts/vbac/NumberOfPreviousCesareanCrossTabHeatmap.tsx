...
const DATA_FILE = "vbac/number_of_previous_cesarean_cross_tab.json";

export default function NumberOfPreviousCesareanCrossTabHeatmap() {
  ...
  return (
    <ChartDataBoundary loading={loading} error={error}>
      {data && rowKeysInOrder.length > 0 && (
        <ResponsiveHeatmap
          title="Number of Previous Cesarean and Successful VBAC"
          columnMajor={data}
          ...
          yAxisLabel="Number of Previous Cesarean Deliveries"
