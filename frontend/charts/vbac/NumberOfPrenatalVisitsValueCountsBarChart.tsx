...
const DATA_FILE = "vbac/number_of_prenatal_visits_value_counts.json";
const TITLE = "Number of prenatal visits counts";

export default function NumberOfPrenatalVisitsValueCountsBarChart() {
