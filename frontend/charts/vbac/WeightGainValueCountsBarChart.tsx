...
const DATA_FILE = "vbac/weight_gain_value_counts.json";
const TITLE = "Distribution of weight gain during pregnancy";

export default function WeightGainValueCountsBarChart() {
