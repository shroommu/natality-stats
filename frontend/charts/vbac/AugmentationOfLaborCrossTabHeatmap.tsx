...
const DATA_FILE = "vbac/augmentation_of_labor_cross_tab.json";

export default function AugmentationOfLaborCrossTabHeatmap() {
  ...
  return (
    <ChartDataBoundary loading={loading} error={error}>
      {data && rowKeysInOrder.length > 0 && (
        <ResponsiveHeatmap
          title="Labor Augmentation and Successful VBAC"
          columnMajor={data}
          ...
          yAxisLabel="Was Labor Augmented?"
